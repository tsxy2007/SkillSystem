...
const FName USkillTreeEditorTypes::PinCategory_MultipleNodes("MultipleNodes");
const FName USkillTreeEditorTypes::PinCategory_SingleComposite("SingleComposite");
